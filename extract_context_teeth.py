...
def extract_context_teeth_surface(file_name = "/home/shirshak/PoinTr/zzz_data_preparation/test_big.ply", three_teeth_segment_ids = [31, 32, 33], tooth_id_to_trim = 32, output_filename="test_big"):
    ...
    mesh_2_pcd_GT_tooth = mesh_to_pcd(three_teeth_mesh, num_points=8192) # 8192 points for Ground Truth
    mesh_2_pcd_context_tooth_surface = mesh_to_pcd(context_tooth_surface, num_points=2048) # 2048 points for 

    np.save(f"/home/shirshak/Teeth_3DS_data_preparation_for_reconstuction_and_generation/outputs/GT_tooth/{output_filename}.npy", mesh_2_pcd_GT_tooth)
    np.save(f"/home/shirshak/Teeth_3DS_data_preparation_for_reconstuction_and_generation/outputs/input_context_surface/{output_filename}.npy", mesh_2_pcd_context_tooth_surface)

    # pcd = o3d.geometry.PointCloud()
    # pcd.points = o3d.utility.Vector3dVector(mesh_2_pcd_GT_tooth)
    # o3d.io.write_point_cloud(os.path.join("/home/shirshak/PoinTr/zzz_data_preparation/outputs/final_tooth.pcd"), pcd)
